...
console.log("Using svelte-as-gun directly from the dist directory");
...
<html>
<head>
  <title>Error - svelte-as-gun Demo</title>
</head>
<body>
...
serve(async (req) => {
  try {
    ...
    // Serve files from the dist directory (for svelte-as-gun access)
