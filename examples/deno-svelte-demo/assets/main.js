...
// Import svelte-as-gun directly - this is what makes Svelte development with Gun easier!
...
// Use svelte-as-gun component API - structure-agnostic
// This is the KEY feature that makes svelte-as-gun powerful - it bridges Gun.js and Svelte
...
// Another powerful feature of svelte-as-gun
...
// Third powerful feature of svelte-as-gun
...
function App() {
  ...
  return {
    mount(target) {
      ...
      // Create the svelte-as-gun features section
      const featuresSection = document.createElement('div');
      const featuresHeading = document.createElement('h2');
      featuresHeading.textContent = 'svelte-as-gun Features';
...
import { component, handle } from 'svelte-as-gun';
import Gun from 'gun';
