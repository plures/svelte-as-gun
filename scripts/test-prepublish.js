/**
 * svelte-as-gun - Pre-publish Test Script
 * 
...
// Print header
console.log("\n===================================");
console.log("svelte-as-gun Pre-publish Check");
console.log("===================================\n");
...
if (pkg.name !== 'svelte-as-gun') {
  console.error(`❌ package.json name is incorrect: ${pkg.name} (should be 'svelte-as-gun')`);
  process.exit(1);
} else {
  console.log("✓ package.json name is correct");
}

if (deno.name !== 'svelte-as-gun') {
  console.error(`❌ deno.json name is incorrect: ${deno.name} (should be 'svelte-as-gun')`);
  process.exit(1);
} else {
