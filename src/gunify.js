/**
 * svelte-as-gun Gunify - Component-agnostic Gun.js data binding for Svelte components
 * 
 ...
 * import { gunify } from '$lib/svgun/gunify';
 * import TodoList from './TodoList.svelte';
 * 
 * export const GunTodoList = gunify(TodoList, {
 *   path: 'todos',
 *   defaultProps: { items: [] }
 * });
 * 
 ...
 * <GunTodoList />
 */
export function gunify(Component, options) {
