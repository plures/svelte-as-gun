/**
 * svelte-as-gun - Local Svelte Gun.js Bindings
 *
...
/**
 * Re-export gunify and connect functions for easier imports
 */
import { gunify, connect } from './gunify.js';
import { gun } from './GunContext.js';

export { gunify, connect, gun };
